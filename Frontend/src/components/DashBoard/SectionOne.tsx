    ...
    <div>
         <div className="mt-12  m-5   ">
           <div className="mb-12 grid gap-y-10 gap-x-10  md:grid-cols-2   lg:grid-col-4  xl:grid-col-4 xl:flex   ">
            ...
            {cardItem.map(({id,icon,textRight,style,image}:any) =>(
              <div key={id} className="raltive flex flex-col bg-clip-border border-2 rounded-xl bg-white text-gray-700 shadow-md w-[600px] h-[200px] hover:scale-95 duration-300">
